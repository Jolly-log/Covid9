...
import Echarts from './plugins/echarts' // 封装Echarts插件
import '../node_modules/_echarts@4.9.0@echarts/map/js/china' // 中国地图资源
import Tabs from './components/tabs' // 封装Tabs切换插件
import '../node_modules/_echarts@4.9.0@echarts/map/js/world' // 世界地图资源
import "../node_modules/echarts/map/js/province/anhui"  // 城市疫情数据
...
import './plugins/vants'  // vant2


Vue.use(Tabs)
Vue.use(Echarts) // 给Echarts插件中传入Vue对象
